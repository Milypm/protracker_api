...
RSpec.describe "Projects API", type: :request do
  ...
  let!(:projects) { FactoryBot.create_list(:project, 10) }
  ...
  describe 'GET /projects' do
    ...
    before {
      ...
      get '/projects', params: { project: { user_id: user.id } }
    }
  ...
  #   # valid payload
  #   let(:valid_attributes) { { name: 'UI implementation for tracking app', deadline: 'Mon, 27 Aug 2021', status: 'Pending' } }
